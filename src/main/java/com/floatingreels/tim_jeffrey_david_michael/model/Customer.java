...
//Author DG
//entiteit om klantenbestand bij te houden, nog niet geïmplementeerd in website
@Entity
public class Customer {
    ...
    //regex gevonden op https://howtodoinjava.com/regex/how-to-build-regex-based-password-validator-in-java/
